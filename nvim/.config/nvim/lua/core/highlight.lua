...
highlight(0, "StatusLineAccent", { fg = mocha.surface0, bg = mocha.mauve })
highlight(0, "StatuslineInsertAccent", { fg = mocha.surface0, bg = mocha.green })
...
highlight(0, "StatuslineCmdLineAccent", { fg = mocha.surface0, bg = mocha.peach })
-- end
